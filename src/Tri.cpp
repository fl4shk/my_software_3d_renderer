...
void Tri::do_project_etc(
    ...
    for (size_t i=0; i<TRI_VERT_SIZE; ++i) {
        ...
        //screen_v.at(i).v.x = (
        //  mult_cx_rw(
        //      proj_v.at(i).v.x, rw_arr.at(i)
        //  )
        //);
        //screen_v.at(i).v.y = (
        //  mult_cx_rw(
        //      proj_v.at(i).v.y, rw_arr.at(i)
        //  )
        //);
        //screen_v.at(i).v.z = (
        //  mult_cx_rw(
        //      proj_v.at(i).v.z, rw_arr.at(i)
        //  )
        //);
...
void Tri::persp_div() {
    for (size_t i=0; i<TRI_VERT_SIZE; ++i) {
        ...
        screen_v.at(i).v.x = (
            (
                ...
                //  rw_arr.at(i)
                //)
                (ndc_v.at(i).v.x + MyFixedPt(1)) * HALF_SCREEN_SIZE_2D.x
                //+ HALF_SCREEN_SIZE_2D.x
            )
        );
        screen_v.at(i).v.y = (
            ...
            //  rw_arr.at(i)
            //)
            (ndc_v.at(i).v.y + MyFixedPt(1)) * HALF_SCREEN_SIZE_2D.y
            //+ HALF_SCREEN_SIZE_2D.y
                ////* MyFixedPt(SCREEN_SIZE_2D.y)
        );
        screen_v.at(i).v.z = (
        ...
        screen_v.at(i).v.w = ndc_v.at(i).v.w;
        screen_v.at(i).uv = ndc_v.at(i).uv;
        //screen_v.at(i).uv.x = (
        //  //temp_v.at(i).uv.x //* rw_arr.at(i)
        //  /// (temp_v.at(i).v.w)
    ...
    for (size_t i=0; i<TRI_VERT_SIZE; ++i) {
        Vec3<double> temp_v;
        for (size_t j=0; j<temp_v.SIZE; ++j) {
            temp_v.at(j) = double(ndc_v.at(i).v.at(j));
        }
        const Vec2<double>
            my_ndc_uv{
