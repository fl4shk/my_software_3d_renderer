...
PREFIX:=snowhousecpu-unknown-elf-
...
PROJ_BASENAME:=$(shell basename $(CURDIR))$(DEBUG_SUFFIX)
PROJ:=$(PROJ_BASENAME).elf
PROJ_BIN=$(PROJ_BASENAME).bin
...
CXX_FLAGS:=$(CXX_FLAGS) \
	...
	-I /home/fl4shk/local/picolibc/snowhousecpu-unknown-elf/include/ \
	-I /home/fl4shk/local/lib/gcc/snowhousecpu-unknown-elf/15.0.1/include \
	-I /home/fl4shk/local/include \
...
LD_FLAGS_POST:=$(LD_FLAGS) $(EXTRA_LD_FLAGS) $(COMMON_LD_FLAGS)
...
.PHONY : all
all : all_pre $(OFILES)
	$(LD) $(LD_FLAGS_PRE) $(OFILES) -o $(PROJ) $(LD_FLAGS_POST) \
